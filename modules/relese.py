...
def generate_release_letter(
    ...
    """
    Generate a release letter for an employee.
    
    Args:
        company_name: Name of the company
        release_date: Date of the release letter
        name: Employee name
    ...
    try:
        ...
        # Load template
        template_path = file("release", company_name)
        ...
        doc.render(context)
        output_file = os.path.join(OUTPUT_DIR, f"Release Letter - {name.title()}.docx")
        doc.save(output_file)
        
        print(f"Success: Release letter generated: {output_file}")
